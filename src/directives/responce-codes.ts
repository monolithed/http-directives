class StatusCodes {
    ...
    public static readonly MULTIPLE_CHOICE = 300;
    ...
    public static readonly REQUESTED_HOST_UNAVAILABLE = 434;
    public static readonly RETRY_WITH = 449;
    ...
    public static readonly BANDWIDTH_LIMIT_EXCEEDED = 509;
    public static readonly NOT_EXTENDED = 510;
    public static readonly NETWORK_AUTHENTICATION_REQUIRED = 511;

    public static readonly UNKNOWN_ERROR = 520;
    public static readonly WEB_SERVER_IS_DOWN = 521;
    public static readonly CONNECTION_TIMED_OUT = 522;
    public static readonly ORIGIN_IS_UNREACHABLE = 523;
    public static readonly A_TIMEOUT_OCCURRED = 524;
    public static readonly SSL_HANDSHAKE_FAILED = 525;
    public static readonly INVALID_SSL_CERTIFICATE = 526;
}
